 ...
 */
async function deriveKek(password, params) {
 ...
 */
export async function wrapVmk(vmk, password, params) {
 ...
 */
export async function unwrapVmk(wrapped, password, params, nonce) {
    const kek = await deriveKek(password, params);
 ...
 */
export function deriveSubkey(vmk, hkdfSalt, context) {
